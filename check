...
update_readme(){
    sed -i -E "s_Episode Name: (.*)_Episode Name: $(printf "$1" | cut -d"/" -f3- | tr "[:punct:]" " ")_g ; s_animixplay.to(.*)_animixplay.to$1_g" README.md
}
...
[ -z "$id" ] && gen_img "gogoplay" "! No" "embed link" "darkorange" || printf "\n\033[1;34mFetching goload links < $id"
...
[ -z "$fb_id" ] && gen_img "xstreamcdn" "! No" "embed link" "darkorange" || printf "\n\033[1;34mFetching xstreamcdn links < $fb_id"
...
[ -z "$dood_id" ] && gen_img "doodstream" "! No" "embed link" "darkorange" || printf "\n\033[1;34mFetching doodstream links < $dood_id"
...
[ -z "$mp4up_link" ] && gen_img "mp4upload" "! No" "embed link" "darkorange" || printf "\n\033[1;34mFetching mp4upload links < $mp4up_link"
...
[ -z "$mp4up_al_link" ] && gen_img "mp4upload_al" "! No" "embed link" "darkorange" || printf "\n\033[1;34mFetching mp4upload (al) links < $mp4up_al_link"
...
[ -z "$lare_id" ] && gen_img "streamlare" "! No" "embed link" "darkorange" || printf "\n\033[1;34mFetching streamlare links < $lare_id"
...
[ -z "$ok_id" ] && gen_img "okru" "! No" "embed link" "darkorange" || printf "\n\033[1;34mFetching odnoklassniki(okru) links < $ok_id"
